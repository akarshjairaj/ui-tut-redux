!(function (e, t) {
  ...
  function j(n, o, i, a, e, t, l) {
    ...
    var u = void 0 === n ? "undefined" : v(n),
      ...
      s =
        "undefined" !== u ||
        (l && l[l.length - 1].lhs && l[l.length - 1].lhs.hasOwnProperty(t)),
      d =
        "undefined" !== f ||
        (l && l[l.length - 1].rhs && l[l.length - 1].rhs.hasOwnProperty(t));
    if (!s && d) i(new b(c, o));
      ...
      if (
        ...
        if ((l.push({ lhs: n, rhs: o }), Array.isArray(n))) {
          ...
          g.forEach(function (e, t) {
            var r = h.indexOf(e);
            0 <= r
              ? (j(n[e], o[e], i, a, c, e, l), (h = x(h, r)))
              : j(n[e], void 0, i, a, c, e, l);
          }),
      ...
      n !== o &&
        (("number" === u && isNaN(n) && isNaN(o)) || i(new y(c, n, o)));
  }
  function c(e, t, r, n) {
    return (
      (n = n || []),
  ...
  (t =
    "object" === ("undefined" == typeof global ? "undefined" : v(global)) &&
    global
      ? global
  ...
  function g(E, k) {
        ...
        void 0 === e
          ? (function (e) {
              ...
              return function (e, t, r) {
                var n = ["action"];
                return (
                  n.push("%c" + String(e.type)),
                  o && n.push("%c@ " + t),
                  i && n.push("%c(in " + r.toFixed(2) + " ms)"),
                  n.join(" ")
                );
              };
            })(k)
    ...
    E.forEach(function (e, t) {
      ...
      g.push(p),
        k.timestamp && g.push("color: gray; font-weight: lighter;"),
        k.duration && g.push("color: gray; font-weight: lighter;");
      var h = O(f, d, l);
      try {
        s
          ? C.title && F
      ...
      A.withTrace && (A.groupCollapsed("TRACE"), A.trace(), A.groupEnd()),
        T && M(i, c, A, s);
      try {
        A.groupEnd();
      } catch (e) {
    ...
    return function (e) {
      ...
      return function (o) {
        return function (e) {
          ...
          if (
            (g(d, Object.assign({}, a, { diff: n })), (d.length = 0), t.error)
          )
            throw t.error;
          return r;
        };
  ...
  var d = function () {
    ...
    if ("function" == typeof t || "function" == typeof r)
      return s()({ dispatch: t, getState: r });
    console.error(
